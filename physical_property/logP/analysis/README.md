...
- [`logP_experimental_values.csv`](logP_experimental_values.csv) -  CSV table of potentiomentric and shake-flask log *P* measurements of 22 molecules and their SMILES.
