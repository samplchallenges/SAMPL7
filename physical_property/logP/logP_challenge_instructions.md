...
For each molecule, participants will be asked to predict the difference in free energy (the transfer free energy) for the neutral form between water and octanol [1,2].
