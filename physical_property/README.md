...
- [`pKa`](pKa): Folder contains challenge input files in `.CSV` format with SMILES of enumerated microstates. This will be updated soon to contain instructions and a submission template.
