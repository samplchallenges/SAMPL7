...
Additionally, there’s the opportunity to predict melting points. Please let us know if you are interested in this. For predictions, participants may use these [SMILES strings](SAMPL7_molecule_ID_and_SMILES.csv). Enumerated microstates are also found [here](pKa).
