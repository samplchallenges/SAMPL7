...
- [`logP/`](logP/): Folder contains an input file in `.CSV` format with SMILES strings of the neutral states of the molecules. This folder contains instructions, a submission template and the analysis for the log *P* challenge.
